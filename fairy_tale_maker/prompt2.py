FAIRYTALE_PRODUCER_DESCRIPTION = (
    ...
    "Coordinates sub-agents in sequence (ContentPlanner → AssetGenerator → StoryAssembler) "
...
Use **VideoAssemblerAgent** to compile the final storybook output.

### Phase 5: Delivery
Present the completed storybook to the user.

## Guidelines:
- Follow the sequence: ContentPlanner → AssetGenerator → VideoAssembler
